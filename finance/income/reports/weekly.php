<?php
// Set page title
$page_title = "Weekly Income Report";
...
if (isset($_GET['export']) && $_GET['export'] === 'pdf') {
    ...
    header('Content-Disposition: attachment; filename="weekly_income_report_' . $year . '_week_' . $week . '.pdf"');
    ...
    <div class="col-md-12 mb-4">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5>Weekly Income Report - Week <?php echo $week; ?>, <?php echo $year; ?> (<?php echo formatDate($startDate); ?> - <?php echo formatDate($endDate); ?>)</h5>
                <div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header bg-light">
                                <h6 class="mb-0">Weekly Income Summary</h6>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <?php else: ?>
                                        <p class="text-muted text-center mt-3">No income recorded for this week</p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td colspan="6" class="text-center">No income records found for the selected week</td>
                                </tr>
                            <?php 
                            }
                            ?>
